...
if exist "Elemental Console Ultra.bat" (
    rename "Elemental ConsoleUltra" "Elemental-Console-Ultra.bat"
)
if exist "Elemental-Console-Ultra.bat" (
    rename "Elemental-Console-Ultra" "Elemental-Console.bat"
)
...
powershell -nologo -noprofile -command "Invoke-WebRequest 'https://raw.githubusercontent.com/TherealDeal-ALt/EE/main/Elemental-ConsoleUltra.bat' -OutFile '%CD%\Elemental ConsoleUltra.bat'"
...
start cmd /k "Elemental-Console-Ultra.bat"
timeout /t 3 /nobreak >nul
del "Elemental-Console-Ultra.bat"

:checks
title Elemental
if exist "C:\auto\settings\" (
...
SET file="%~dp0%computername%.txt"
echo -------------------------------------------- >> %file%
echo Loaded By Elemental Console >> %file%
echo Details For: %system% >> %file%
echo Manufacturer: %manufacturer% >> %file%
echo Model: %model% >> %file%
echo Serial Number: %serialnumber% >> %file%
...
echo Service Pack: %sp% >> %file%
echo -------------------------------------------- >> %file%
echo Goto The File With Elemental Console
REM request user to push any key to continue
pause
